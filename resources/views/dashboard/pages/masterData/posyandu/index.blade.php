...
@section('buttonPanelHeader')
    <a href="{{ url('master-data/puskesmas') }}" class="btn btn-secondary btn-round" id=""><i
    ...
    @component('dashboard.components.buttons.add',
        [
            'id' => 'btn-tambah',
            'class' => '',
            'url' => url('master-data/posyandu/' . $puskesmas->id . '/create'),
        ])
    @endcomponent
@endsection
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-head-row">
                        <div class="card-title">Data POSYANDU</div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modal-tambah-title">Tambah POSYANDU</h5>
    ...
    <script>
        $(document).on('click', '#btn-delete', function() {
            ...
            swal({
                ...
                if (Delete) {
                    $.ajax({
                        url: "{{ url('master-data/posyandu/' . $puskesmas->id) }}" + '/' + id,
                        type: 'DELETE',
                        data: {
                            '_token': '{{ csrf_token() }}'
                        },
