            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-head-row">
                        <div class="card-title">Data Sumber Dana</div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modal-tambah-title">Tambah Sumber Dana</h5>
                    ...
                    <div class="modal-body">
                        @component('dashboard.components.formElements.input',
                            [
                                ...
                                'type' => 'text',
                                'label' => 'Sumber Dana',
                                'placeholder' => 'Tambah Sumber Dana',
                                'name' => 'nama',
                                'required' => true,
                            ])
                        @endcomponent
...
@push('scripts')
    <script>
        ...
        $('#btn-tambah').click(function() {
            ...
            $('#modal-tambah-title').html('Tambah Sumber Dana');
            $('#nama').val('');
        })
        ...
        $(document).on('click', '#btn-edit', function() {
            ...
            $.ajax({
                url: "{{ url('master-data/sumber-dana') }}" + '/' + id + '/edit',
                type: "GET",
                data: {
                    id: id
                },
                success: function(response) {
                    aksiTambah = 'ubah';
                    $('#modal-tambah').modal('show');
                    $('#modal-tambah-title').html('Ubah Sumber Dana');
            ...
            swal({
                ...
                if (Update) {
                    if (aksiTambah == 'tambah') {
                        ...
                        $.ajax({
                            url: "{{ url('master-data/sumber-dana') }}" + '/' + idEdit,
                            type: 'PUT',
                            data: $(this).serialize(),
                            success: function(response) {
                                if (response.status == 'success') {
        ...
        $(document).on('click', '#btn-delete', function() {
            ...
            swal({
                ...
                if (Delete) {
                    $.ajax({
                        url: "{{ url('master-data/sumber-dana') }}" + '/' + id,
                        type: 'DELETE',
                        data: {
                            '_token': '{{ csrf_token() }}'
                        },
    ...
    <script>
        ...
        $('#nav-master-sumber-dana').addClass('active');
