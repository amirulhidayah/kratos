            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-head-row">
                        <div class="card-title">Form Laporan Realisasi Intervensi Habitat </div>
                    </div>
                </div>
                        ...
                        <div class="col">
                            @component('dashboard.components.forms.realisasi',
                                [
                                    ...
                                    'lokasiArr' => $lokasiPerencanaanArr,
                                    'dataMap' => $dataMap,
                ...
                <div class="card-body px-2">
                    <div class="table-responsive">
                        <table class="table table-hover table-striped" id="tabelLokasiTerealisasi" cellspacing="0"
                            ...
                            <tbody>
                                @foreach ($rencanaIntervensi->lokasiPerencanaan->whereNull('realisasi_keong_id') as $item)
                                    <tr>
